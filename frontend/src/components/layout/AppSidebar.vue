...
const WEB_IMAGE_GENERATOR_HREF = 'https://gpt-image-playground.121api.com/'
...
function createWebImageGeneratorNavItem(): NavItem {
  return {
    path: WEB_IMAGE_GENERATOR_HREF,
    label: t('nav.webImageGenerator'),
    icon: ImageGenerateIcon,
    externalHref: WEB_IMAGE_GENERATOR_HREF,
    externalTarget: '_blank',
  }
}
...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    ...
    createWebImageGeneratorNavItem(),
